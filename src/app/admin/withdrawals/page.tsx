              ...
              <tbody className="divide-y divide-slate-200 bg-white">
                {adminWithdrawals.map((withdrawal) => (
                  <tr key={withdrawal.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-4">{withdrawal.memberName}</td>
                    <td className="px-4 py-4">{withdrawal.amount}</td>
                    <td className="px-4 py-4">{withdrawal.requestedDate}</td>
                    <td className="px-4 py-4">{withdrawal.payoutMethod}</td>
